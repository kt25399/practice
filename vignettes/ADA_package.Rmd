...
nba <- read_csv("/Users/queller/Desktop/NBA.csv")
...
salary <- read_csv("/Users/queller/Desktop/NBA_season1718_salary.csv")
...
df_with_loadings %>% ggplot(aes(x = Pos, y = PC1, color = Pos)) + geom_point() + geom_boxplot()
fit <- lm(PC1 ~ Pos, data = df_with_loadings)
summary(fit)
...
df_with_loadings %>% ggplot(aes(x = Pos, y = PC2, color = Pos)) + geom_point() + geom_boxplot()
fit <- aov(PC2 ~ Pos, data = df_with_loadings)
summary(fit)
TukeyHSD(fit)
...
df_with_loadings %>% ggplot(aes(x = Pos, y = PC3, color = Pos)) + geom_point() + geom_boxplot()
fit <- aov(PC3 ~ Pos, data = df_with_loadings)
summary(fit)
TukeyHSD(fit)
