...
## The dataset
Loading in the custom data sets used in these exercises. The first is a dataframe of common statistics for the top 200 players from the NBA. The second includes the salaries of these 
...
### K-means clustering
#### {optimal_cluster}
The first function {optimal_cluster} uses three methods to help determine the optimal number of clusters for any given dataset. To use optimal cluster, input the dataset you want to explore.
...
The next graph is the silhouette method which take the peak width as the optimal number of clusters
...
Finally the gap statistic, which agains show 2 clusters is optimal.
